...
import { Discord, Facebook, GitHubDark } from "developer-icons";
...
export const Footer = ({
  logo = <span className="font-bold text-foreground text-xl">OpenDev</span>,
  links = defaultLinks,
  ...
  return (
    <footer className="border-border border-t bg-background w-full">
      <div className="mx-auto max-w-7xl px-6 py-6">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-foreground/60 text-sm">{copyright ?? <>&copy; {new Date().getFullYear()} Tous droit reserves</>}</span>
          </div>
